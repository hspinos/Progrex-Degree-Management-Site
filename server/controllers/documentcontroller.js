...
exports.check_document_signed = async function (req, res) {
	try {
		...
		let data = document.usersSigned.find((signData) =>
...
exports.set_document_signed = async function (req, res) {
	try {
		...
		const document = await Document.findById(req.params.docId);
		if (
			document.usersSigned.find((signData) => signData.signerId.equals(userId))
		) {
			res.status(401).send("Error, user has already signed this document.");
		} else {
		...
		let sampleDocuments = [
			{
				name: "Document 1",
				description:
					"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam nec feugiat lorem, sed efficitur nulla. Donec elementum augue ac ex suscipit fermentum.",
				powerFormUrl:
					"https://demo.docusign.net/Member/PowerFormSigning.aspx?PowerFormId=a438791b-188d-4644-921f-ffb1e3c27a76&env=demo&acct=34cdbed2-d10f-48e3-9c43-2f2058f7b861&v=2",
			},
			{
				name: "Document 2",
				description:
					"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam nec feugiat lorem, sed efficitur nulla. Donec elementum augue ac ex suscipit fermentum.",
				powerFormUrl:
					"https://demo.docusign.net/Member/PowerFormSigning.aspx?PowerFormId=d817cc62-ebcb-4f9b-8fe9-1357b6f41438&env=demo&acct=34cdbed2-d10f-48e3-9c43-2f2058f7b861&v=2",
			},
			{
				name: "Document 3",
				description:
					"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam nec feugiat lorem, sed efficitur nulla. Donec elementum augue ac ex suscipit fermentum.",
				powerFormUrl:
					"https://demo.docusign.net/Member/PowerFormSigning.aspx?PowerFormId=1f4b3887-8d1d-45c9-97a5-e9c0889f47cc&env=demo&acct=34cdbed2-d10f-48e3-9c43-2f2058f7b861&v=2",
			},
			{
				name: "Document 4",
				description:
					"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam nec feugiat lorem, sed efficitur nulla. Donec elementum augue ac ex suscipit fermentum.",
				powerFormUrl:
					"https://demo.docusign.net/Member/PowerFormSigning.aspx?PowerFormId=94da1d20-0e4e-4574-bd37-48f467ba6b34&env=demo&acct=34cdbed2-d10f-48e3-9c43-2f2058f7b861&v=2",
			},
			{
				name: "Document 5",
				description:
					"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam nec feugiat lorem, sed efficitur nulla. Donec elementum augue ac ex suscipit fermentum.",
				powerFormUrl:
					"https://demo.docusign.net/Member/PowerFormSigning.aspx?PowerFormId=83ec3a52-62d1-4e5e-8b03-c3fea2bfbc4a&env=demo&acct=34cdbed2-d10f-48e3-9c43-2f2058f7b861&v=2",
			},
			{
				name: "Document 6",
				description:
					"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam nec feugiat lorem, sed efficitur nulla. Donec elementum augue ac ex suscipit fermentum.",
				powerFormUrl:
					"https://demo.docusign.net/Member/PowerFormSigning.aspx?PowerFormId=c148659b-602f-410a-8ee7-6f1f6ad2cfce&env=demo&acct=34cdbed2-d10f-48e3-9c43-2f2058f7b861&v=2",
			},
		];
