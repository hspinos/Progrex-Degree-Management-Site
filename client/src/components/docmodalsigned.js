            ...
            <div className="modal-dialog modal-dialog-centered relative w-auto pointer-events-none">
                <div
                    ...
                    <div
                        ...
                        <h5 className="text-xl font-medium leading-normal text-gray-800 dark:text-white" id="signedModalTitle">
                            Modal title
                        </h5>
                        <button type="button"
                    ...
                    <div className="modal-body relative p-4" id="signedModalBody">
                        ...
                    </div>
                    <div
