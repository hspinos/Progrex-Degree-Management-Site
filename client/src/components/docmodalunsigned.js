            ...
            <div className="relative px-4 w-full max-w-xl h-full md:h-auto">
                <div className="relative bg-white rounded-lg shadow dark:bg-stone-800">
                    ...
                    <div id="modalFooter" className="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-stone-700">
                        <button id='signButton' data-modal-toggle="unsignedModal" type="button" className="text-white bg-red-500 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-blue-800">Sign Now</button>
