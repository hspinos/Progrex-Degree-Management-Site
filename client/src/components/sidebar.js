...
<div className=" hidden lg:block my-4 ml-4 shadow-lg relative w-80">
    <div className="bg-white rounded-2xl dark:bg-stone-800">
        <div className="flex items-center justify-center pt-6">
             <h1 className="mx-4 text-4xl font-normal">
                        BADGES
                    </h1>
        </div>
        <nav className="mt-6">
            <div>
                <a className="w-full font-thin uppercase text-green-500 flex items-center p-4 my-2 transition-colors duration-200 justify-start bg-gradient-to-r from-white to-blue-100 border-r-4 border-blue-500 dark:from-gray-700 dark:to-gray-800 border-r-4 border-blue-500" href="#">
                ...
                <a className="w-full font-thin uppercase text-gray-500 dark:text-gray-200 flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:text-green-500" href="#">
                    <span className="text-left">
